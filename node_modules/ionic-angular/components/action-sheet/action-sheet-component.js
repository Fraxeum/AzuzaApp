...
var ActionSheetCmp = (function () {
    ...
    ActionSheetCmp.prototype.click = function (button) {
        ...
        if (shouldDismiss) {
            console.log("DISMISS LN89");
            try{
                this.dismiss(button.role);
            } catch(error){
                console.log("DISMISS LN89 => Error caught");
            }
    ...
    ActionSheetCmp.prototype.dismiss = function (role) {
        ...
        console.log("DISMISS LN107");
        
        let e = null;
        try{
           e = this._viewCtrl.dismiss(null, role, opts).then(function (done){
           ...
           return true;
            ...
            console.log("ERROR CAUGHT IN THE DEEP");
            return false;
        }
