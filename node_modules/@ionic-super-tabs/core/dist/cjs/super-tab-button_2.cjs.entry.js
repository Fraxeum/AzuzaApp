...
const core = require('./core-d0f39c38.js');
const utils = require('./utils-5617fa07.js');
...
const SuperTabButtonComponent = class {
    ...
    render() {
        return (core.h(core.Host, { role: "button", "aria-label": this.label ? this.label.innerText : false, "aria-disabled": this.disabled ? 'true' : false, "aria-selected": this.active ? 'true' : 'false', class: {
            ...
            } }, core.h("slot", null), core.h("ion-ripple-effect", { type: "unbounded" })));
    }
...
const SuperTabsToolbarComponent = class {
    constructor(hostRef) {
        ...
        this.hostCls = {};
        this.clientWidth = 0;
        this.buttonClick = core.createEvent(this, "buttonClick", 7);
    }
    ...
    render() {
        return (core.h(core.Host, { role: "navigation", class: this.hostCls }, core.h("div", { class: "buttons-container", ref: (ref) => this.buttonsContainerEl = ref }, core.h("slot", null), this.showIndicator &&
            core.h("super-tab-indicator", { ref: (ref) => this.indicatorEl = ref, toolbarPosition: this.el.assignedSlot.name }))));
    }
    get el() { return core.getElement(this); }
